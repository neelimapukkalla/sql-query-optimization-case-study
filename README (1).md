...
- Add actual SSMS execution-plan screenshots (Scan vs. Seek) alongside the script output
- Record real `STATISTICS IO/TIME` output from a run against Azure SQL Database (free tier) or a local SQL Server Express instance
